...
void DrawRoom(int place_x, int place_y, int room_w, int room_h, int room_id)
{
	...
	if (room_id == 0) {
#ifdef PS2
		Paint(place_x+1, place_y+1, room_w-2, room_h-2, "cdrom0:\\DATA\\D\\CENTRE.LOC");
#else
	...
	if ((room_id % 1000) == 499) {
#ifdef PS2
		Paint(place_x+1, place_y+1, room_w-2, room_h-2, "cdrom0:\\DATA\\D\\WEAPON.LOC");
#else
	...
	if ((room_id % 1000) == 999) {
#ifdef PS2
		Paint(place_x+1, place_y+1, room_w-2, room_h-2, "cdrom0:\\DATA\\D\\BOSSROOM.LOC");
#else
